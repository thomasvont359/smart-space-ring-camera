...
export const metadata: Metadata = {
  ...
  description:
    "Smart Space is Ireland's trusted Ring installer. Learn about our mission to bring professional smart home security to every Irish home.",
};
      ...
      <section className="bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
            Ireland&apos;s authorised Ring installer, bringing professional smart home
            security to homes across the country.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <p>
                  As an authorised Ring installer, we don&apos;t just sell products — we deliver
                ...
                <p>
                  Based in Dublin, we serve customers across Ireland with same commitment
